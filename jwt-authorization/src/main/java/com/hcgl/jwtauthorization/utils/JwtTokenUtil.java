package com.hcgl.jwtauthorization.utils;


import com.hcgl.jwtauthorization.common.exception.CustomException;
...
public class JwtTokenUtil {
    ...
    public static Claims parseJWT(String jsonWebToken, String base64Security) {
        ...
        try {
            ...
            logger.error("===== Token信息： =====" + ResultCode.PERMISSION_TOKEN_EXPIRED);
            throw new CustomException(ResultCode.PERMISSION_TOKEN_EXPIRED);
        } catch (Exception e) {
            logger.error("===== token解析异常 =====", e);
            logger.error("===== token解析异常码： =====" + ResultCode.PERMISSION_TOKEN_INVALID);
    ...
    public static String createJWT(String userId, String username, String role, Audience audience) {
        ...
        try {
            ...
            if (TTLMillis >= 0) {
                ...
                logger.info("=========JWT的过期时间=========", exp);
                logger.info("=========JWT生效的开始时间=========", now);
